                ...
                for batch_size in bsbs:
                    for num_epoch, lr in lrlr:
                        ...
                        for seed in seeds:
                            ...
                            results = pd.read_excel('C:\\Users\\user\\Desktop\\1\\Modeling\\21. SG 혼합물 독성 예측\\output\\20241105_SG_MDR_results.xlsx')
                            results.loc[results.shape[0]] = i_results
                            results.to_excel('C:\\Users\\user\\Desktop\\1\\Modeling\\21. SG 혼합물 독성 예측\\output\\20241105_SG_MDR_results.xlsx',index=False)
